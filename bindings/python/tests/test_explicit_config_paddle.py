...
from utils_explicit_config import PaddleAdapter, run_save_load_file_test, run_save_load_bytes_test
...
def adapter():
    try:
        ...
        pytest.skip("Paddle not installed")

def test_save_load_file_explicit_config_paddle(adapter, enc_config, tmp_path):
    run_save_load_file_test(adapter, enc_config, tmp_path)

def test_save_load_bytes_explicit_config_paddle(adapter, enc_config):
