...
class TorchAdapter(FrameworkAdapter):
    ...
    def generate_data(self):
        return {
            "test": self.torch.randn(10, 10),
            "test2": self.torch.zeros(5, 5)
        }
...
class TensorflowAdapter(FrameworkAdapter):
    ...
    def generate_data(self):
        return {
            "test": self.tf.random.normal((10, 10)),
            "test2": self.tf.zeros((5, 5))
        }
...
class FlaxAdapter(FrameworkAdapter):
    ...
    def generate_data(self):
        return {
            "test": self.jnp.ones((10, 10)),
            "test2": self.jnp.zeros((5, 5))
        }
...
class MlxAdapter(FrameworkAdapter):
    ...
    def generate_data(self):
        return {
            "test": self.mx.random.normal((10, 10)),
            "test2": self.mx.zeros((5, 5))
        }
...
class PaddleAdapter(FrameworkAdapter):
    ...
    def generate_data(self):
        return {
            "test": self.paddle.randn((10, 10)),
            "test2": self.paddle.zeros((5, 5))
        }
